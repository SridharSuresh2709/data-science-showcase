...
import profileImage from "../assests/Sridhar_image_for_lk.jpg";
      ...
      <div className="container relative z-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-shrink-0 animate-fade-in" style={{ animationDelay: "0.15s" }}>
            <div className="relative">
              <img
                src={profileImage}
                alt="Sridhar S"
                className="w-40 h-40 md:w-56 md:h-56 rounded-full object-cover border-4 border-primary/30 shadow-xl"
              />
              <div className="absolute inset-0 rounded-full blur-2xl bg-primary/20 -z-10" />
            </div>
          </div>
          ...
          <div className="text-center md:text-left">
            <p
              className="mono text-primary text-sm md:text-base mb-4 animate-fade-in"
            ...
            <h2
              className="text-2xl md:text-4xl lg:text-5xl font-semibold text-muted-foreground mb-6 animate-fade-in"
            ...
            <p
              className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-8 animate-fade-in leading-relaxed"
